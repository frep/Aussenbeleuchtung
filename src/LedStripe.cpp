...
void LedStripe::FadeInOut(byte red, byte green, byte blue)
{
  float r, g, b;
...
void LedStripe::HalloweenEyes(byte red, byte green, byte blue, int EyeWidth, int EyeSpace, boolean Fade, int Steps, int FadeDelay, int EndPause)
{
...
void LedStripe::NewKITT(byte red, byte green, byte blue, int EyeSize, int SpeedDelay, int ReturnDelay)
{
...
void LedStripe::Twinkle(byte red, byte green, byte blue, int Count, int SpeedDelay, boolean OnlyOne) 
{
  setAll(0,0,0);
...
void LedStripe::TwinkleRandom(int Count, int SpeedDelay, boolean OnlyOne) 
{
  setAll(0,0,0);
...
void LedStripe::Sparkle(byte red, byte green, byte blue, int SpeedDelay) 
{
...
void LedStripe::SnowSparkle(byte red, byte green, byte blue, int SparkleDelay, int SpeedDelay) 
{
  setAll(red,green,blue);
...
void LedStripe::RunningLights(byte red, byte green, byte blue, int WaveDelay) 
{
  int Position=0;
...
void LedStripe::rainbowCycle(int SpeedDelay) 
{
  byte *c;
  uint16_t i, j;
...
byte * LedStripe::Wheel(byte WheelPos) 
{
  static byte c[3];
...
void LedStripe::theaterChaseRainbow(int SpeedDelay) 
{
  byte *c;
...
void LedStripe::Fire(int Cooling, int Sparking, int SpeedDelay) 
{
...
void LedStripe::setPixelHeatColor (int Pixel, byte temperature) 
{
...
void LedStripe::BouncingColoredBalls(int BallCount, byte colors[][3], boolean continuous) 
{
  float Gravity = -9.81;
  int StartHeight = 1;
...
void LedStripe::meteorRain(byte red, byte green, byte blue, byte meteorSize, byte meteorTrailDecay, boolean meteorRandomDecay, int SpeedDelay) 
{  
  setAll(0,0,0);
...
void LedStripe::setAll(byte red, byte green, byte blue) 
{
  for(int i = 0; i < NUM_LEDS; i++ ) {
    setPixel(i, red, green, blue); 
  }
